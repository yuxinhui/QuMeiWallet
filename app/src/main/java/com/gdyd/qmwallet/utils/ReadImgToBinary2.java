...
public class ReadImgToBinary2 {
     ...
     * @return
     */
    public static String imgToBase64(String imgPath,int Width,int Height, Bitmap bitmap,String imgFormat) {
        if (imgPath !=null && imgPath.length() > 0) {
        //    bitmap = readBitmap(imgPath);
             bitmap = getBitmap(imgPath, Width*4, Height*4);
            Log.d("zanZQ", "imgToBase64: "+Width*4+"Height*5,"+Height*4);
        }else if(bitmap == null){
            //bitmap not found!!
        }
        ...
        //    Log.d("zanZQ", "imgToBase64: "+s.trim().length());
        //    Log.d("zanZQ", "imgToBase64: "+s);
        //   Log.d("zanZQ", "imgToBase64: "+s.trim());
     //      Log.d("zanZQ", "imgToBase64:1 "+s.toString().trim().substring(0,s.trim().length()));
//            Log.d("zanZQ", "imgToBase64:2 "+s.toString().trim().substring(4000,s.trim().length()));
//
//          Log.d("zanZQ", "imgToBase64:3 "+s.toString().trim().substring(8000,s.trim().length()));
//            if (s.trim().length()>12000){
//                Log.d("zanZQ", "imgToBase64:4 "+s.toString().trim().substring(12000,s.trim().length()));
//            }
//            Log.d("zanZQ", "imgToBase64:4 "+s.toString().trim().substring(12000,16000));
//            Log.d("zanZQ", "imgToBase64:5 "+s.toString().trim().substring(16000,20000));
//            Log.d("zanZQ", "imgToBase64:6 "+s.toString().trim().substring(20000,24000));
//            Log.d("zanZQ", "imgToBase64: 7"+s.toString().trim().substring(24000,28000));
//            Log.d("zanZQ", "imgToBase64:8 "+s.toString().trim().substring(32000,36000));
//            Log.d("zanZQ", "imgToBase64:9"+s.toString().trim().substring(36000,40000));
//            Log.d("zanZQ", "imgToBase64:10"+s.toString().trim().substring(40000,44000));
//            Log.d("zanZQ", "imgToBase64:11 "+s.toString().trim().substring(44000,48000));
//            Log.d("zanZQ", "imgToBase64:12"+s.toString().trim().substring(48000,52000));
//            Log.d("zanZQ", "imgToBase64: 13"+s.toString().trim().substring(52000,56000));
    ...
    public static Bitmap getBitmap2(String path, int  destWidth, int destHeight) {
        /**********************第一次采样，目的就是为了计算缩放比例***************************************/
        BitmapFactory.Options options = new BitmapFactory.Options();
        //设置只加载图像的边界到内存中
        options.inJustDecodeBounds = true;
