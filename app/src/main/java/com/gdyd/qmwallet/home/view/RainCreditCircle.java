...
public class RainCreditCircle extends View {
    ...
    public RainCreditCircle(Context context) {
        this(context, null);
    }

    public RainCreditCircle(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RainCreditCircle(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(getmLevel(), mCenterX, mCenterY - dp2px(40), mPaint);
        ...
        canvas.drawText(getElavateTime(), mCenterX, mCenterY + dp2px(25), mPaint);
    }
    ...
    public String getElavateTime() {
        return elavateTime;
    }

    public void setElavateTime(String elavateTime) {
        this.elavateTime = elavateTime;
        postInvalidate();
    }
